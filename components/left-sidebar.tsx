  ...
  return (
    ...
    >
      <div className="space-y-4">
        ...
        <div className="bg-slate-800/50 rounded-lg p-3 shadow-md border border-slate-700/50 hover:border-fofa-cyan/30 transition-colors">
          <h3 className="text-xs font-medium text-fofa-gray-300 mb-3 flex items-center gap-1.5">
            ...
            {productDistribution.length > 0 ? (
              productDistribution.map(([product, count]) => (
                <li
                  ...
                  className="flex justify-between items-center hover:bg-slate-700/30 px-2 py-1 rounded-md"
                >
                  <Link href="#" className="text-fofa-gray-100 hover:text-fofa-cyan truncate">
                    {product}
                  </Link>
                  <span className="text-fofa-gray-400 bg-slate-700/50 px-1.5 py-0.5 rounded-md text-xs">{count}</span>
                </li>
